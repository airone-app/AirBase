...
@implementation NSString (AirBase64)
/*
...
- (NSString *)air_base64Encode
{
	...
	NSString *strToReturn = [[NSString alloc] initWithBytesNoCopy:strResult length:objPointer - strResult encoding:NSUTF8StringEncoding freeWhenDone:YES];
	return strToReturn;
}
...
- (NSString *)air_base64Decode
{
    ...
    return [[NSString alloc] initWithBytesNoCopy:objResult length:j encoding:NSUTF8StringEncoding freeWhenDone:YES];
}


#pragma mark - GTMBase64 Implement

- (NSString *)GTMBase64Encode
{
    NSData *orginalData = [self dataUsingEncoding:NSUTF8StringEncoding];
    NSData *encodeData = [GTMBase64 encodeData:orginalData];
...
{
    NSData *orginalData = [self dataUsingEncoding:NSUTF8StringEncoding];
    NSData *decodeData = [GTMBase64 decodeData:orginalData];
